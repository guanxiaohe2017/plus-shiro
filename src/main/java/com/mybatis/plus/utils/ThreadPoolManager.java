...
public class ThreadPoolManager {
     ...
     * 线程池基本大小
     */
    private static final int SIZE_CORE_POOL = SIZE_DEFAULT;

    /**
     * 线程池最大数量
     */
    private static final int SIZE_MAX_POOL = SIZE_DEFAULT;
     ...
     * 线程工厂
     */
    ThreadFactory namedThreadFactory = new ThreadFactoryBuilder().setNameFormat("cleanRecord-pool-%d").build();
    ...
    private final ThreadPoolExecutor mThreadPool = new ThreadPoolExecutor(SIZE_CORE_POOL, SIZE_MAX_POOL, 0L,
            TimeUnit.MILLISECONDS, new LinkedBlockingQueue<>(),namedThreadFactory, new
